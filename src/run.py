...
parser.add_argument('--use_middle_cls_token', type=str, choices=['true', 'false'], default='true')


args = parser.parse_args()
if args.use_wandb:
    project_name = "ssast_final"  # default project name
    if args.dataset == "esc50":
        project_name = "ssast_esc"
    elif args.dataset == "audioset":
        project_name = "ssast_as"
...
val_loader = torch.utils.data.DataLoader(
    ...
    batch_size=args.batch_size * 2, shuffle=False, num_workers=4, pin_memory=False)
...
vision_mamba_config = {
    ...
    # Add more VisionMamba specific parameters here as needed
}
